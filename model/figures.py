...
def main():
    ...
    rq4 = [("wide_multiproj", {"greedy": 158.9, "model": 16.1, "oracle": 16.1, "none": 20.6}),
           ("mixed_widths", {"greedy": 73.6, "model": 11.1, "oracle": 11.1, "none": 13.9}),
           ("fp32_block", {"greedy": 37.8, "model": 13.5, "oracle": 4.45, "none": 5.39})]
    fig_rq4(rq4)
