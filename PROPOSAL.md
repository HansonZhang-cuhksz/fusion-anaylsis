...
- [x] Automated `ncu` → vendor-neutral dataset (`data/microbench_timing.csv` 72 rows; 64 genuine + 8 degenerate no-ops excluded from scoring, plus `data/microbench_ncu.csv`), with `beneficial?` + `dominant_penalty`
